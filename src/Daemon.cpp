...
Command Daemon::ParseData(dataType &mex)
{
	...
	if (N >=4  and !strcmp( (char*) mex.data(), "SEND")  )
		//	((char*)mex.data() ) [0]== 'S' and
		//	((char*)mex.data() ) [1]== 'E' and
		//	((char*)mex.data() ) [2]== 'N' and
		//	((char*)mex.data() ) [3]== 'D' and
	...
	else if (N >=4  and !strcmp( (char*) mex.data(), "RECV")  )
		{
		mex.erase(0,5);
		myCmd.cmd=RECV;
		myCmd.data = mex.data();
	...
	else if (N >=4  and !strcmp( (char*) mex.data(), "DATA")  )
		{
		mex.erase(0,5);
		myCmd.cmd=DATA;
		myCmd.data = mex.data();
	...
	else if (N >=3  and !strcmp( (char*) mex.data(), "NOP")  )
		myCmd.cmd=NOP;
	else if (N >=3  and !strcmp( (char*) mex.data(), "WWE")  )
		myCmd.cmd=WWE;
	else if (N >=2  and !strcmp( (char*) mex.data(), "WE")  )
		myCmd.cmd=WE;
	else if (N >=2  and !strcmp( (char*) mex.data(), "EE")  )
		myCmd.cmd=EE;
	else if (N >=3  and !strcmp( (char*) mex.data(), "WBT")  )
		myCmd.cmd=WBT;
	else if (N >=3  and !strcmp( (char*) mex.data(), "WBE")  )
		myCmd.cmd=WBE;
	else if (N >=3  and !strcmp( (char*) mex.data(), "EBT")  )
		myCmd.cmd=EBT;
	//	else if (N >=7  and !strcmp( (char*) mex.data(), "STATUS")  ) // move in the not null terminated part TODO
	//		{
	//		mex.erase(0,7);
	...
	//		mex.release();
	//		}
	else if (N >=8  and !strcmp( (char*) mex.data(), "STARTRUN")  )
		{
		mex.erase(0,9);
		myCmd.cmd=STARTRUN;
		myCmd.data = mex.data();
	...
	else if (N >=10  and !strcmp( (char*) mex.data(), "SPILLCOMPL")  )
		myCmd.cmd=SPILLCOMPL;
